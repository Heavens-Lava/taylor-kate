  ...
  return (
    <div className="bg-gradient-to-r from-pink-200 to-purple-200 min-h-screen relative">
      ...
      <div className="text-center my-10">
        ...
        <div className="flex items-center justify-center m-10">
          <img className="h-[272px] rounded-lg shadow-xl" src={lashes} alt="lash design" />
        </div>
        <Link to="/SHOP-LASHES">
          <button className="mt-4 px-6 py-2 bg-pink-600 text-white rounded-full shadow hover:bg-pink-700 transition">
            Shop Lashes
...
<div className="text-xl mt-10 flex flex-col items-end px-4 md:px-20 space-y-6">
  {[
    ...
    { text: "And don't forget, the lashes are to die for!", type: "chat-start", style: "chat-bubble-warning" },
    { text: "I'm getting those too! 💕", type: "chat-end", style: "chat-bubble-success" }
  ].map((chat, i) => {
    const ChatBubble = () => {
