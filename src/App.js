...
return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-xl p-6 w-96 relative">
        ...
        <p className="text-gray-700 mb-4">Enter your email to receive an exclusive discount on your first booking.</p>
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex justify-between">
            <button type="submit" className="btn btn-pink-600 text-white">Claim Offer</button>
